  ...
  return (
    <Card className="w-full shadow-2xl border border-gray-200 bg-white">
      <CardHeader className="space-y-4 pb-8 pt-8">
        ...
        <CardTitle className="text-3xl text-center font-bold text-gray-900">Blog Colaborativo</CardTitle>
      ...
      <CardContent>
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="text-center text-sm pt-2">
            ...
            <Link href="/auth/register" className="text-[#0052A5] hover:text-[#003d7a] font-semibold hover:underline">
              Cadastre-se
            </Link>
          </div>
        </form>
